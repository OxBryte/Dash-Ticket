  ...
  const events = [
    {
      ...
      shortDescription:
        "Experience the musical journey through all of Taylor's eras",
      description:
        "Join Taylor Swift for an unforgettable night featuring songs from all her albums. This spectacular production includes elaborate stage designs, costume changes, and performances of fan-favorite hits spanning her entire career. Doors open at 6:00 PM, show starts at 7:30 PM. Merchandise available at multiple locations throughout the venue.",
      category: "CONCERT",
      status: "ON_SALE",
      ...
      refundPolicy:
        "Tickets are non-refundable except in case of event cancellation. Refunds will be processed within 30 days.",
      ...
      ticketTypes: [
        ...
        },
        {
          name: "VIP Experience",
          description:
            "Includes premium seating, exclusive merchandise, early entry, and meet & greet opportunity",
          price: 99900, // $999
          quantityTotal: 200,
          maxPerOrder: 2,
        },
    ...
    },
    {
      ...
      ageRestriction: "ALL_AGES",
      refundPolicy:
        "Refunds available up to 48 hours before event. No refunds after that time.",
      organizerId: organizer1.id,
    ...
    },
    {
      ...
      description:
        'Arctic Monkeys return to San Francisco for a special intimate performance at The Fillmore. Experience their latest album "The Car" plus classic hits in this historic venue. Limited capacity ensures an unforgettable experience. Doors at 7:00 PM, show at 8:00 PM.',
      category: "CONCERT",
      status: "ON_SALE",
    ...
    },
    {
      ...
      description:
        "Watch the Chicago Cubs take on the Los Angeles Dodgers in this exciting regular season matchup at historic Wrigley Field. Experience the tradition and excitement of America's pastime at one of baseball's most iconic venues. Game time: 1:20 PM. Gates open at 11:20 AM.",
      category: "SPORTS",
      status: "ON_SALE",
      ...
      ageRestriction: "ALL_AGES",
      refundPolicy:
        "Tickets are non-refundable. In case of rain delay or postponement, tickets will be honored for the rescheduled date.",
      ...
      ticketTypes: [
        ...
        },
        {
          name: "Club Level",
          description:
            "Premium club level with access to exclusive lounges and dining",
          price: 15000, // $150
          quantityTotal: 3000,
          maxPerOrder: 6,
        },
    ...
    },
    {
      ...
      shortDescription:
        "An evening of iconic film scores conducted by John Williams",
      description:
        "Experience the magic of cinema with legendary composer John Williams conducting the Los Angeles Philharmonic. This special evening features iconic scores from Star Wars, Harry Potter, Jurassic Park, E.T., and more. Bring a picnic and enjoy this unforgettable outdoor concert under the stars. Show starts at 8:00 PM.",
      category: "CONCERT",
      status: "ON_SALE",
      ...
      ageRestriction: "ALL_AGES",
      refundPolicy:
        "Refunds available up to 24 hours before the event. No refunds for weather-related cancellations.",
      organizerId: organizer1.id,
